...
.AddJwtBearer("JwtBearer", options =>
{
    options.TokenValidationParameters = new TokenValidationParameters
    {
        ...
        ValidIssuer = "webapi.Health_Clinic",
        ValidAudience = "webapi.Health_Clinic"
    };
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Version = "v1",
        Title = "API Health Clinic Manha",
        Description = " API para gerenciamento de onsultas - Projeto Health Clinic - Backend API",
